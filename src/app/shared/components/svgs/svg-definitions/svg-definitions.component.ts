...
@Component({
  ...
  template: `
    ...
    >
      <symbol viewBox="0 0 6.35 7.938" id="arrow-down" xmlns="http://www.w3.org/2000/svg">
        <path
      ...
      <symbol viewBox="0 0 6.35 7.938" id="arrow-up" xmlns="http://www.w3.org/2000/svg">
        <path
          style="line-height:normal;font-variant-ligatures:normal;font-variant-position:normal;font-variant-caps:normal;font-variant-numeric:normal;font-variant-alternates:normal;font-feature-settings:normal;text-indent:0;text-align:start;text-decoration-line:none;text-decoration-style:solid;text-decoration-color:#000;text-transform:none;text-orientation:mixed;white-space:normal;shape-padding:0;isolation:auto;mix-blend-mode:normal;solid-color:#000;solid-opacity:1"
      ...
      <symbol viewBox="0 0 24 24" id="board">
        <g fill="currentColor">
          <path
      ...
      <symbol viewBox="0 0 16 16" id="bug" xmlns="http://www.w3.org/2000/svg">
      ...
      <symbol viewBox="0 0 24 24" id="cog">
        <path
      ...
      <symbol viewBox="0 0 24 24" id="component">
        <g fill="currentColor" fill-rule="evenodd">
          <path
            d="M5 17.991c0 .007 14.005.009 14.005.009-.006 0-.005-7.991-.005-7.991C19 10.002 4.995 10 4.995 10 5.001 10 5 17.991 5 17.991zM3 10.01C3 8.899 3.893 8 4.995 8h14.01C20.107 8 21 8.902 21 10.009v7.982c0 1.11-.893 2.009-1.995 2.009H4.995A2.004 2.004 0 013 17.991V10.01z"
          />
          <path
      ...
      <symbol viewBox="0 0 160 146" id="no-result" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient x1="14.22%" y1="85.365%" x2="85.257%" y2="14.651%" id="na">
            <stop stop-color="#C1C7D0" offset="56%" />
            <stop stop-color="#E9EBEF" stop-opacity=".5" offset="97%" />
          </linearGradient>
        </defs>
      ...
      <symbol viewBox="0 0 24 24" id="report">
        <g fill="currentColor">
          <path
            d="M21 17H4.995C4.448 17 4 16.548 4 15.991V6a1 1 0 10-2 0v9.991A3.004 3.004 0 004.995 19H21a1 1 0 000-2zm-3-8v3a1 1 0 002 0V8a1 1 0 00-1-1h-4a1 1 0 000 2h3z"
          />
          <path
      ...
      <symbol viewBox="0 0 24 24" id="ship">
        <g fill="currentColor" fill-rule="evenodd">
          ...
          />
          <path
            d="M6 7.005C6 5.898 6.898 5 7.998 5h2.004C11.106 5 12 5.894 12 7.005V10H6V7.005zm4 0V7H7.999c.005 0 .002.003.002.005V8h2v-.995z"
          />
          <path
      ...
      <symbol viewBox="0 0 16 16" id="story" xmlns="http://www.w3.org/2000/svg">
        <g transform="translate(1 1)" fill="none" fill-rule="evenodd">
      ...
      <symbol viewBox="0 0 16 16" id="task" xmlns="http://www.w3.org/2000/svg">
        <g transform="translate(1 1)" fill="none" fill-rule="evenodd">
          <rect fill="#4BADE8" width="14" height="14" rx="2" />
          <path d="M6 9.5l4-5m-4 5l-2-2" stroke="#FFF" stroke-width="2" stroke-linecap="round" />
        </g>
      </symbol>
      <symbol viewBox="0 0 24 24" id="times">
        <path
      ...
      <symbol viewBox="0 0 24 24" id="spin" xmlns="http://www.w3.org/2000/svg">
        <path
