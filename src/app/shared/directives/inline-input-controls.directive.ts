...
@Directive({
  selector: '[xtraInlineInputControls]',
  standalone: true,
...
export class InlineInputControlsDirective implements OnDestroy {
  ...
  @Input('xtraInlineInputControls') public controlPanel!: ControlPanel;
  ...
  openPanel(): void {
    ...
    const templatePortal = new TemplatePortal(this.controlPanel.templateRef, this.viewContainerRef);
    this.overlayRef.attach(templatePortal);

    this.panelClosingActionsSub = this.panelClosingActions().subscribe(() => this.destroyPanel());
  }
