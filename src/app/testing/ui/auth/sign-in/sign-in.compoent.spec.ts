...
describe('SignInComponent', () => {
  ...
  const crudServiceMock = {
    post: jasmine
      .createSpy('post')
      .and.returnValue(Promise.resolve({ status: true, response: { userToken: 'mockToken' } })),
  };
  ...
  it('should be Crud Service created', () => {
    const service: CrudService<any> = TestBed.get(CrudService<any>);
  ...
  it('should handle form submission when apiResponse.status is true', fakeAsync(() => {
    ...
    crudServiceMock.post.and.returnValue(
      Promise.resolve({ status: true, response: { userToken: 'mockToken' } }),
    );
    ...
    expect(routerMock.navigate).toHaveBeenCalledWith([
      '/' + AppRoutes.DashBoard.RootDashBoard + '/' + AppRoutes.DashBoard.RootDashBoard,
    ]);
  }));
  ...
  it('should handle form submission when apiResponse.status is false', fakeAsync(() => {
    ...
    crudServiceMock.post.and.returnValue(
      Promise.resolve({ status: false, message: 'Error message' }),
    );
